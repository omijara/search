...
//Search Query if search result is match
...
<div class="container">
    ...
    <div id="content" class="col-xs-6 col-sm-9 col-md-10">
       ...
       <thead>
        <!--If match found which is greater than 0 then you will get found message-->
    ...
    <?php 
        ...
        //if match not found then you will get not match found message
      print ($msg2);
      }
